...
export declare class Rive {
    ...
    private loaded;
    private _observed;
    private _customDevicePixelRatio;
    /**
     ...
     */
    setDataContextFromInstance(viewModelInstance: ViewModelInstance | null): void;
    get viewModelInstance(): ViewModelInstance;
...
export declare class ViewModelInstance {
    ...
    constructor(runtimeInstance: rc.ViewModelInstance, root: ViewModelInstance);
    get runtimeInstance(): rc.ViewModelInstance;
    ...
    property(path: string): ViewModelInstanceValue;
